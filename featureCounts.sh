...
cd $inputDir/bam_files

# Read bam files from bam_list.txt
bamFiles=$(cat bam_list.txt | tr '\n' ' ')

$featureCountsDir/bin/featureCounts -p -B -C -g gene_id -a /gpfs0/tals/projects/data/Transcriptomes/human_hg38/Homo_sapiens.GRCh38.113_chr_HN1.gtf -o $inputDir/expression_table/expression_table_HN1.txt $bamFiles
