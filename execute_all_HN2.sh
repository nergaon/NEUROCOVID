...
while IFS=$'\t' read -r line || [[ -n "$line" ]]; do
	...
	arg2=${arrIN[1]/$'\r'/}			#name 
	echo $arg1
	#qsub -cwd -V -q tals.q execute_single_bam_junc_HN1.sh $arg1 $arg2 #create bam and junc files. align to human genome
	qsub -cwd -V -q tals.q execute_single_SARS-CoV-2_HN1.sh $arg1 $arg2 #align to virus genome
done < "$1"
